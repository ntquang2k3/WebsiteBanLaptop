                                ...
                                <div class="col-lg-3 col-md-3">
                                    <div class="card-product">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <a href="./thongtinSP.php?id=<?php echo $firstProduct['MaSP'] ?>"><?php echo $firstProduct['TenSP'] ?></a>
                                                <div style="color: red;">
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="card-product">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <a href="./thongtinSP.php?id=<?php echo $product['MaSP'] ?>"><?php echo $product['TenSP'] ?></a>
                                                    <div style="color: red;">
